...
static void hkdf_check_out_key(GsecHashFunction hash_function,
...
TEST(AesGcmGsecCrypterTest, DeriveSecret) {
  ...
  std::vector<uint8_t> prk_1 = {0x07, 0x77, 0x09, 0x36, 0x2c, 0x2e, 0x32, 0xdf,
                                0x0d, 0xdc, 0x3f, 0x0d, 0xc4, 0x7b, 0xba, 0x63,
                                0x90, 0xb6, 0xc7, 0x3b, 0xb5, 0x0f, 0x9c, 0x31,
                                0x22, 0xec, 0x84, 0x4a, 0xd7, 0xc2, 0xb3, 0xe5};
  std::vector<uint8_t> correct_out_key_1 = {
      0x3c, 0xb2, 0x5f, 0x25, 0xfa, 0xac, 0xd5, 0x7a, 0x90, 0x43, 0x4f,
      0x64, 0xd0, 0x36, 0x2f, 0x2a, 0x2d, 0x2d, 0x0a, 0x90, 0xcf, 0x1a,
      0x5a, 0x4c, 0x5d, 0xb0, 0x2d, 0x56, 0xec, 0xc4, 0xc5, 0xbf, 0x34,
      0x00, 0x72, 0x08, 0xd5, 0xb8, 0x87, 0x18, 0x58, 0x65};

  std::vector<uint8_t> info_2 = {
  ...
  std::vector<uint8_t> prk_2 = {0x06, 0xa6, 0xb8, 0x8c, 0x58, 0x53, 0x36, 0x1a,
                                0x06, 0x10, 0x4c, 0x9c, 0xeb, 0x35, 0xb4, 0x5c,
                                0xef, 0x76, 0x00, 0x14, 0x90, 0x46, 0x71, 0x01,
                                0x4a, 0x19, 0x3f, 0x40, 0xc1, 0x5f, 0xc2, 0x44};
  std::vector<uint8_t> correct_out_key_2 = {
  ...
  std::vector<uint8_t> info_3 = {};
  std::vector<uint8_t> prk_3 = {0x19, 0xef, 0x24, 0xa3, 0x2c, 0x71, 0x7b, 0x16,
                                0x7f, 0x33, 0xa9, 0x1d, 0x6f, 0x64, 0x8b, 0xdf,
                                0x96, 0x59, 0x67, 0x76, 0xaf, 0xdb, 0x63, 0x77,
                                0xac, 0x43, 0x4c, 0x1c, 0x29, 0x3c, 0xcb, 0x04};
  std::vector<uint8_t> correct_out_key_3 = {
  ...
  hkdf_check_out_key(GsecHashFunction::SHA256_hash_function, info_1, prk_1,
                     correct_out_key_1);
  hkdf_check_out_key(GsecHashFunction::SHA256_hash_function, info_2, prk_2,
                     correct_out_key_2);
  hkdf_check_out_key(GsecHashFunction::SHA256_hash_function, info_3, prk_3,
                     correct_out_key_3);
