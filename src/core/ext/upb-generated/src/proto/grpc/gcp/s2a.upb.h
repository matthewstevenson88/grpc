...
UPB_INLINE const s2a_proto_Identity* const* s2a_proto_ClientSessionStartReq_target_identities(const s2a_proto_ClientSessionStartReq *msg, size_t *len) { return (const s2a_proto_Identity* const*)_upb_array_accessor(msg, UPB_SIZE(36, 56), len); }
UPB_INLINE const s2a_proto_Identity* s2a_proto_ClientSessionStartReq_local_identity(const s2a_proto_ClientSessionStartReq *msg) { return UPB_FIELD_AT(msg, const s2a_proto_Identity*, UPB_SIZE(24, 32)); }
...
UPB_INLINE s2a_proto_Identity** s2a_proto_ClientSessionStartReq_mutable_target_identities(s2a_proto_ClientSessionStartReq *msg, size_t *len) {
  return (s2a_proto_Identity**)_upb_array_mutable_accessor(msg, UPB_SIZE(36, 56), len);
}
UPB_INLINE s2a_proto_Identity** s2a_proto_ClientSessionStartReq_resize_target_identities(s2a_proto_ClientSessionStartReq *msg, size_t len, upb_arena *arena) {
  return (s2a_proto_Identity**)_upb_array_resize_accessor(msg, UPB_SIZE(36, 56), len, UPB_SIZE(4, 8), UPB_TYPE_MESSAGE, arena);
}
...
UPB_INLINE void s2a_proto_ClientSessionStartReq_set_local_identity(s2a_proto_ClientSessionStartReq *msg, s2a_proto_Identity* value) {
  UPB_FIELD_AT(msg, s2a_proto_Identity*, UPB_SIZE(24, 32)) = value;
}
...
UPB_INLINE const s2a_proto_Identity* const* s2a_proto_ServerSessionStartReq_local_identities(const s2a_proto_ServerSessionStartReq *msg, size_t *len) { return (const s2a_proto_Identity* const*)_upb_array_accessor(msg, UPB_SIZE(32, 48), len); }
...
UPB_INLINE s2a_proto_Identity** s2a_proto_ServerSessionStartReq_mutable_local_identities(s2a_proto_ServerSessionStartReq *msg, size_t *len) {
  return (s2a_proto_Identity**)_upb_array_mutable_accessor(msg, UPB_SIZE(32, 48), len);
}
UPB_INLINE s2a_proto_Identity** s2a_proto_ServerSessionStartReq_resize_local_identities(s2a_proto_ServerSessionStartReq *msg, size_t len, upb_arena *arena) {
  return (s2a_proto_Identity**)_upb_array_resize_accessor(msg, UPB_SIZE(32, 48), len, UPB_SIZE(4, 8), UPB_TYPE_MESSAGE, arena);
}
...
UPB_INLINE const s2a_proto_Identity* s2a_proto_SessionResult_peer_identity(const s2a_proto_SessionResult *msg) { return UPB_FIELD_AT(msg, const s2a_proto_Identity*, UPB_SIZE(28, 56)); }
UPB_INLINE const s2a_proto_Identity* s2a_proto_SessionResult_local_identity(const s2a_proto_SessionResult *msg) { return UPB_FIELD_AT(msg, const s2a_proto_Identity*, UPB_SIZE(32, 64)); }
...
UPB_INLINE void s2a_proto_SessionResult_set_peer_identity(s2a_proto_SessionResult *msg, s2a_proto_Identity* value) {
  UPB_FIELD_AT(msg, s2a_proto_Identity*, UPB_SIZE(28, 56)) = value;
}
...
UPB_INLINE void s2a_proto_SessionResult_set_local_identity(s2a_proto_SessionResult *msg, s2a_proto_Identity* value) {
  UPB_FIELD_AT(msg, s2a_proto_Identity*, UPB_SIZE(32, 64)) = value;
}
