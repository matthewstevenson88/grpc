...
#ifndef GRPC_CORE_TSI_S2A_HANDSHAKER_S2A_HANDSHAKER_CLIENT_H_
#define GRPC_CORE_TSI_S2A_HANDSHAKER_S2A_HANDSHAKER_CLIENT_H_
...
class S2AHandshakerClient {
 public:
   ...
   *  arguments. **/
  S2AHandshakerClient(tsi_handshaker* handshaker, grpc_channel* channel,
   ...
   *  received and no error has occurred, then this method invokes |cb_|. **/
  ...
  void SetFieldsForTesting(tsi_handshaker* handshaker,
                           tsi_handshaker_on_next_done_cb cb, void* user_data,
 ...
 private:
  ...
  std::unique_ptr<s2a_proxy::S2AProxy> proxy_;
  bool is_start_ = true;
};
...
#endif  // GRPC_CORE_TSI_S2A_HANDSHAKER_S2A_HANDSHAKER_CLIENT_H_
