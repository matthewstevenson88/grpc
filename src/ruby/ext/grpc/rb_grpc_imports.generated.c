...
grpc_s2a_credentials_options_create_type grpc_s2a_credentials_options_create_import;
grpc_s2a_credentials_options_set_handshaker_service_url_type grpc_s2a_credentials_options_set_handshaker_service_url_import;
grpc_s2a_credentials_options_add_supported_ciphersuite_type grpc_s2a_credentials_options_add_supported_ciphersuite_import;
grpc_s2a_credentials_options_add_target_service_account_type grpc_s2a_credentials_options_add_target_service_account_import;
grpc_s2a_credentials_options_destroy_type grpc_s2a_credentials_options_destroy_import;
grpc_s2a_credentials_create_type grpc_s2a_credentials_create_import;
grpc_s2a_server_credentials_create_type grpc_s2a_server_credentials_create_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_s2a_credentials_options_create_import = (grpc_s2a_credentials_options_create_type) GetProcAddress(library, "grpc_s2a_credentials_options_create");
  grpc_s2a_credentials_options_set_handshaker_service_url_import = (grpc_s2a_credentials_options_set_handshaker_service_url_type) GetProcAddress(library, "grpc_s2a_credentials_options_set_handshaker_service_url");
  grpc_s2a_credentials_options_add_supported_ciphersuite_import = (grpc_s2a_credentials_options_add_supported_ciphersuite_type) GetProcAddress(library, "grpc_s2a_credentials_options_add_supported_ciphersuite");
  grpc_s2a_credentials_options_add_target_service_account_import = (grpc_s2a_credentials_options_add_target_service_account_type) GetProcAddress(library, "grpc_s2a_credentials_options_add_target_service_account");
  grpc_s2a_credentials_options_destroy_import = (grpc_s2a_credentials_options_destroy_type) GetProcAddress(library, "grpc_s2a_credentials_options_destroy");
  grpc_s2a_credentials_create_import = (grpc_s2a_credentials_create_type) GetProcAddress(library, "grpc_s2a_credentials_create");
  grpc_s2a_server_credentials_create_import = (grpc_s2a_server_credentials_create_type) GetProcAddress(library, "grpc_s2a_server_credentials_create");
