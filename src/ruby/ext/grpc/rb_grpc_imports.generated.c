...
grpc_tls_credentials_options_set_client_ca_list_type grpc_tls_credentials_options_set_client_ca_list_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_tls_credentials_options_set_client_ca_list_import = (grpc_tls_credentials_options_set_client_ca_list_type) GetProcAddress(library, "grpc_tls_credentials_options_set_client_ca_list");
