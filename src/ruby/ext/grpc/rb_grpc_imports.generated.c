...
grpc_s2a_credentials_client_options_create_type grpc_s2a_credentials_client_options_create_import;
grpc_alts_credentials_server_options_create_type grpc_alts_credentials_server_options_create_import;
grpc_s2a_credentials_client_options_add_target_service_account_type grpc_s2a_credentials_client_options_add_target_service_account_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_s2a_credentials_client_options_create_import = (grpc_s2a_credentials_client_options_create_type) GetProcAddress(library, "grpc_s2a_credentials_client_options_create");
  grpc_alts_credentials_server_options_create_import = (grpc_alts_credentials_server_options_create_type) GetProcAddress(library, "grpc_alts_credentials_server_options_create");
  grpc_s2a_credentials_client_options_add_target_service_account_import = (grpc_s2a_credentials_client_options_add_target_service_account_type) GetProcAddress(library, "grpc_s2a_credentials_client_options_add_target_service_account");
