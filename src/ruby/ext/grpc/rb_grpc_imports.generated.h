...
typedef grpc_s2a_credentials_options*(*grpc_s2a_credentials_client_options_create_type)(void);
extern grpc_s2a_credentials_client_options_create_type grpc_s2a_credentials_client_options_create_import;
#define grpc_s2a_credentials_client_options_create grpc_s2a_credentials_client_options_create_import
typedef grpc_alts_credentials_options*(*grpc_alts_credentials_server_options_create_type)(void);
extern grpc_alts_credentials_server_options_create_type grpc_alts_credentials_server_options_create_import;
#define grpc_alts_credentials_server_options_create grpc_alts_credentials_server_options_create_import
typedef void(*grpc_s2a_credentials_client_options_add_target_service_account_type)(grpc_s2a_credentials_options* options, const char* service_account);
extern grpc_s2a_credentials_client_options_add_target_service_account_type grpc_s2a_credentials_client_options_add_target_service_account_import;
#define grpc_s2a_credentials_client_options_add_target_service_account grpc_s2a_credentials_client_options_add_target_service_account_import
