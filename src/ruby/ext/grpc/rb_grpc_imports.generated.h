...
typedef grpc_s2a_credentials_options*(*grpc_s2a_credentials_options_create_type)(void);
extern grpc_s2a_credentials_options_create_type grpc_s2a_credentials_options_create_import;
#define grpc_s2a_credentials_options_create grpc_s2a_credentials_options_create_import
typedef void(*grpc_s2a_credentials_options_set_handshaker_service_url_type)(grpc_s2a_credentials_options* options, const char* handshaker_service_url);
extern grpc_s2a_credentials_options_set_handshaker_service_url_type grpc_s2a_credentials_options_set_handshaker_service_url_import;
#define grpc_s2a_credentials_options_set_handshaker_service_url grpc_s2a_credentials_options_set_handshaker_service_url_import
typedef void(*grpc_s2a_credentials_options_add_supported_ciphersuite_type)(grpc_s2a_credentials_options* options, grpc_s2a_ciphersuite ciphersuite);
extern grpc_s2a_credentials_options_add_supported_ciphersuite_type grpc_s2a_credentials_options_add_supported_ciphersuite_import;
#define grpc_s2a_credentials_options_add_supported_ciphersuite grpc_s2a_credentials_options_add_supported_ciphersuite_import
typedef void(*grpc_s2a_credentials_options_add_target_service_account_type)(grpc_s2a_credentials_options* options, const char* target_service_account);
extern grpc_s2a_credentials_options_add_target_service_account_type grpc_s2a_credentials_options_add_target_service_account_import;
#define grpc_s2a_credentials_options_add_target_service_account grpc_s2a_credentials_options_add_target_service_account_import
typedef void(*grpc_s2a_credentials_options_destroy_type)(grpc_s2a_credentials_options* options);
extern grpc_s2a_credentials_options_destroy_type grpc_s2a_credentials_options_destroy_import;
#define grpc_s2a_credentials_options_destroy grpc_s2a_credentials_options_destroy_import
typedef grpc_channel_credentials*(*grpc_s2a_credentials_create_type)(const grpc_s2a_credentials_options* options);
extern grpc_s2a_credentials_create_type grpc_s2a_credentials_create_import;
#define grpc_s2a_credentials_create grpc_s2a_credentials_create_import
typedef grpc_server_credentials*(*grpc_s2a_server_credentials_create_type)(const grpc_s2a_credentials_options* options);
extern grpc_s2a_server_credentials_create_type grpc_s2a_server_credentials_create_import;
#define grpc_s2a_server_credentials_create grpc_s2a_server_credentials_create_import
